...
[![CI status](https://github.com/erboladaiorg/et-minus/workflows/Node.js%20CI/badge.svg)](https://github.com/erboladaiorg/et-minus/actions?query=workflow%3A%22Node.js+CI%22)
[![Coverage Status](https://coveralls.io/repos/github/erboladaiorg/et-minus/badge.svg?branch=master)](https://coveralls.io/github/erboladaiorg/et-minus?branch=master)
[![NPM version](https://img.shields.io/npm/v/@erboladaiorg/et-minus.svg)](https://www.npmjs.com/package/@erboladaiorg/et-minus)
![npm](https://img.shields.io/npm/dm/@erboladaiorg/et-minus)
...
```bash
npm install @erboladaiorg/et-minus
```
...
```javascript
// ESM
import { Validator } from "@erboladaiorg/et-minus";
...
```javascript
// CommonJS
const { Validator } = await (import("@erboladaiorg/et-minus"));
```
...
```bash
npm install @erboladaiorg/et-minus -g
...
```bash
npx -p @erboladaiorg/et-minus validate-api <filename>
```
...
```bash
npx -p @erboladaiorg/et-minus bundle-api <spec files> 
```
